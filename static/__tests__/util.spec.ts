...
describe('immutableSplice', () => {
  it('can delete elements', () => {
    ...
    expect(immutableSplice(months, months.length - 1, 1)).toEqual([
      'Jan',
      'Feb',
      'March',
    ]);
  ...
  it('can add elements', () => {
    ...
    expect(immutableSplice(['Feb', 'March'], 0, 0, 'Jan')).toEqual([
      'Jan',
      'Feb',
      'March',
    ]);
    expect(immutableSplice(['Jan', 'Feb'], months.length, 0, 'March')).toEqual([
      'Jan',
      'Feb',
      'March',
    ]);
